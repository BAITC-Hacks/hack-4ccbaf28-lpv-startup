...
The subsequent engine milestone passed all six live Definition of Done scenarios; see [DEFINITION-OF-DONE.md](DEFINITION-OF-DONE.md). Current checks: 28 tests. Explicit start-screen quick requests now display 15 October 2026, city and budget and search on click; conversational drafts still require confirmation. Portrait illustrations are circular face crops; venue/work images remain rectangular.
